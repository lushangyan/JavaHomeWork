...
import io.kimmking.rpcfx.netty4.MyClientInboundHandler;
...
public class AbstarctRpcfx {
    ...
    protected static RpcfxResponse nettyPost(RpcfxRequest request, String url) throws Exception {

//        SimpleChannelInboundHandler<FullHttpResponse> simpleChannelInboundHandler = new SimpleChannelInboundHandler<FullHttpResponse>() {
//            @Override
...
//        };
        ...
        MyClientInboundHandler myClientInboundHandler = new MyClientInboundHandler();
        myClientInboundHandler.setCountDownLatch(new CountDownLatch(1));
        RpcfxResponse rpcfxResponse = NettyHttpClient.sendRequest(request, url, myClientInboundHandler);
